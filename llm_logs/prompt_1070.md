...
Parent 2 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'strategy'), 3)"]
 Parent 3:
 with fitness 7.7353
Parent 3 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'memLevel'), 5)"]
 Parent 4:
 with fitness 7.7289
Parent 4 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'strategy'), 2)"]
 Parent 5:
 with fitness 7.7353
Parent 5 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'level'), 6)"]
