...
Available parents:
 Parent 1:
 with fitness 5.3302
Parent 1 has 4 edits: ["ParamSetting(('scipy.params', 'param', 'jac'), 'cs')", "ParamSetting(('scipy.params', 'param', 'method'), 'L-BFGS-B')", "ParamSetting(('scipy.params', 'param', 'maxiter'), 4545)", "ParamSetting(('scipy.params', 'param', 'tol'), 0.055215874491563954)"]
 Parent 2:
 with fitness 5.232
