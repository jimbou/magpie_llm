...
Available parents:
 Parent 1:
 with fitness 4.9865
Parent 1 has 5 edits: ["ParamSetting(('scipy.params', 'param', 'jac'), 'cs')", "ParamSetting(('scipy.params', 'param', 'method'), 'L-BFGS-B')", "ParamSetting(('scipy.params', 'param', 'tol'), 0.043345875121013996)", "ParamSetting(('scipy.params', 'param', 'disp'), 'False')", "ParamSetting(('scipy.params', 'param', 'maxiter'), 3644)"]
 Parent 2:
 with fitness 4.9865
