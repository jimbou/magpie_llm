...
Available parents:
 Parent 1:
 with fitness 6.9698
Parent 1 has 1 edits: ["ParamSetting(('test.params', 'param', 'PHASE'), 'PhaseCachingAutoEraseStrategy')"]
 Parent 2:
 with fitness 6.9539
Parent 2 has 1 edits: ["ParamSetting(('test.params', 'param', 'LUBYFACTOR'), 311)"]
 Parent 3:
 with fitness 6.9363
