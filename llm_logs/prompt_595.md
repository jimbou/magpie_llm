...
Available parents:
 Parent 1:
 with fitness 6.9059
Parent 1 has 1 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 195)"]
 Parent 2:
 with fitness 6.8918
Parent 2 has 1 edits: ["ParamSetting(('test.params', 'param', 'RESTARTS'), 'ArminRestarts')"]
 Parent 3:
 with fitness 6.8164
...
Parent 4 has 1 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 91)"]
 Parent 5:
 with fitness 6.8968
Parent 5 has 1 edits: ["ParamSetting(('test.params', 'param', 'CONFLICTBOUNDINCFACTOR'), 3.8111784563043374)"]
