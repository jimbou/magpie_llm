...
Available parents:
 Parent 1:
 with fitness 6.623
Parent 1 has 2 edits: ["ParamSetting(('zlib.params', 'param', 'strategy'), 3)", "ParamSetting(('zlib.params', 'param', 'memLevel'), 6)"]
 Parent 2:
 with fitness 7.6069
Parent 2 has 3 edits: ["ParamSetting(('zlib.params', 'param', 'level'), 7)", "ParamSetting(('zlib.params', 'param', 'wbits'), 30)", "ParamSetting(('zlib.params', 'param', 'strategy'), 2)"]
 Parent 3:
 with fitness 7.7289
Parent 3 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'strategy'), 2)"]
 Parent 4:
 with fitness 7.7353
Parent 4 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'memLevel'), 5)"]
 Parent 5:
 with fitness 7.6124
Parent 5 has 4 edits: ["ParamSetting(('zlib.params', 'param', 'wbits'), 30)", "ParamSetting(('zlib.params', 'param', 'strategy'), 2)", "ParamSetting(('zlib.params', 'param', 'memLevel'), 5)", "ParamSetting(('zlib.params', 'param', 'level'), 6)"]
