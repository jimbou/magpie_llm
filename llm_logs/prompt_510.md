...
Available parents:
 Parent 1:
 with fitness 3.1177
Parent 1 has 7 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'sub-lim$bounded'), 6419)", "ParamSetting(('minisat_advanced.params', 'param', 'cl-lim$unbounded'), '-1')", "ParamSetting(('minisat_advanced.params', 'param', '@sub-lim$flag'), 'False')", "ParamSetting(('minisat_advanced.params', 'param', 'verb'), '1')", "ParamSetting(('minisat_advanced.params', 'param', 'cp-increase'), 7337)", "ParamSetting(('minisat_advanced.params', 'param', '@cl-lim$flag'), 'True')", "ParamSetting(('minisat_advanced.params', 'param', 'sub-lim$bounded'), 9195)"]
 Parent 2:
 with fitness 3.1478
Parent 2 has 6 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'cp-increase'), 7337)", "ParamSetting(('minisat_advanced.params', 'param', 'var-decay'), 0.825520469471721)", "ParamSetting(('minisat_advanced.params', 'param', 'elim'), 'True')", "ParamSetting(('minisat_advanced.params', 'param', '@sub-lim$flag'), 'False')", "ParamSetting(('minisat_advanced.params', 'param', 'sub-lim$bounded'), 6419)", "ParamSetting(('minisat_advanced.params', 'param', '@cl-lim$flag'), 'True')"]
 Parent 3:
 with fitness 3.1177
Parent 3 has 6 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'sub-lim$bounded'), 6419)", "ParamSetting(('minisat_advanced.params', 'param', 'cl-lim$unbounded'), '-1')", "ParamSetting(('minisat_advanced.params', 'param', '@sub-lim$flag'), 'False')", "ParamSetting(('minisat_advanced.params', 'param', 'verb'), '1')", "ParamSetting(('minisat_advanced.params', 'param', 'cp-increase'), 7337)", "ParamSetting(('minisat_advanced.params', 'param', '@cl-lim$flag'), 'True')"]
 Parent 4:
 with fitness 3.1478
Parent 4 has 7 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'cp-increase'), 7337)", "ParamSetting(('minisat_advanced.params', 'param', 'elim'), 'True')", "ParamSetting(('minisat_advanced.params', 'param', 'var-decay'), 0.825520469471721)", "ParamSetting(('minisat_advanced.params', 'param', '@sub-lim$flag'), 'False')", "ParamSetting(('minisat_advanced.params', 'param', 'sub-lim$bounded'), 6419)", "ParamSetting(('minisat_advanced.params', 'param', '@cl-lim$flag'), 'True')", "ParamSetting(('minisat_advanced.params', 'param', 'cl-lim$unbounded'), '-1')"]
 Parent 5:
 with fitness 3.1478
Parent 5 has 7 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'elim'), 'True')", "ParamSetting(('minisat_advanced.params', 'param', 'cp-increase'), 7337)", "ParamSetting(('minisat_advanced.params', 'param', 'var-decay'), 0.825520469471721)", "ParamSetting(('minisat_advanced.params', 'param', '@sub-lim$flag'), 'False')", "ParamSetting(('minisat_advanced.params', 'param', 'sub-lim$bounded'), 6419)", "ParamSetting(('minisat_advanced.params', 'param', '@cl-lim$flag'), 'True')", "ParamSetting(('minisat_advanced.params', 'param', 'sub-lim$unbounded'), '-1')"]
