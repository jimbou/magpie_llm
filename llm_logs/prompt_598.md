...
Parent 1 has 1 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 76)"]
 Parent 2:
 with fitness 6.8968
Parent 2 has 1 edits: ["ParamSetting(('test.params', 'param', 'CONFLICTBOUNDINCFACTOR'), 3.8111784563043374)"]
 Parent 3:
 with fitness 6.8758
Parent 3 has 1 edits: ["ParamSetting(('test.params', 'param', 'VARDECAY'), 0.9397026973187748)"]
 Parent 4:
 with fitness 6.83
Parent 4 has 1 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 252)"]
 Parent 5:
 with fitness 6.8918
Parent 5 has 1 edits: ["ParamSetting(('test.params', 'param', 'RESTARTS'), 'ArminRestarts')"]
