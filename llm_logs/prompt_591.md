...
Available parents:
 Parent 1:
 with fitness 6.8758
Parent 1 has 1 edits: ["ParamSetting(('test.params', 'param', 'VARDECAY'), 0.9397026973187748)"]
 Parent 2:
 with fitness 6.8968
Parent 2 has 1 edits: ["ParamSetting(('test.params', 'param', 'CONFLICTBOUNDINCFACTOR'), 3.8111784563043374)"]
 Parent 3:
 with fitness 6.9059
Parent 3 has 1 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 195)"]
 Parent 4:
 with fitness 6.858
