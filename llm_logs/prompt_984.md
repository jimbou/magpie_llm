...
Available parents:
 Parent 1:
 with fitness 9.3757
Parent 1 has 1 edits: ["ParamSetting(('scipy.params', 'param', 'maxiter'), 6745)"]
 Parent 2:
 with fitness 10.0068
Parent 2 has 1 edits: ["ParamSetting(('scipy.params', 'param', 'tol'), 0.043345875121013996)"]
 Parent 3:
 with fitness 8.6466
Parent 3 has 1 edits: ["ParamSetting(('scipy.params', 'param', 'jac'), 'cs')"]
 Parent 4:
 with fitness 10.0673
Parent 4 has 1 edits: ["ParamSetting(('scipy.params', 'param', 'maxiter'), 9427)"]
 Parent 5:
 with fitness 9.2528
Parent 5 has 1 edits: ["ParamSetting(('scipy.params', 'param', 'maxiter'), 7051)"]
