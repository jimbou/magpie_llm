...
Available parents:
 Parent 1:
 with fitness 3.214
Parent 1 has 4 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'cl-lim$unbounded'), '-1')", "ParamSetting(('minisat_advanced.params', 'param', 'elim'), 'True')", "ParamSetting(('minisat_advanced.params', 'param', '@sub-lim$flag'), 'False')", "ParamSetting(('minisat_advanced.params', 'param', 'cp-increase'), 7337)"]
 Parent 2:
 with fitness 3.1918
Parent 2 has 3 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'var-decay'), 0.825520469471721)", "ParamSetting(('minisat_advanced.params', 'param', 'cp-increase'), 7337)", "ParamSetting(('minisat_advanced.params', 'param', 'elim'), 'True')"]
 Parent 3:
 with fitness 3.214
Parent 3 has 1 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'cp-increase'), 7337)"]
 Parent 4:
 with fitness 3.214
Parent 4 has 5 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'sub-lim$unbounded'), '-1')", "ParamSetting(('minisat_advanced.params', 'param', 'cl-lim$unbounded'), '-1')", "ParamSetting(('minisat_advanced.params', 'param', '@sub-lim$flag'), 'False')", "ParamSetting(('minisat_advanced.params', 'param', 'verb'), '1')", "ParamSetting(('minisat_advanced.params', 'param', 'cp-increase'), 7337)"]
 Parent 5:
 with fitness 3.1918
