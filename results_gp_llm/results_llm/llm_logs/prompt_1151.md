...
Available parents:
 Parent 1:
 with fitness 3.95
Parent 1 has 1 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'verb'), '2')"]
 Parent 2:
 with fitness 3.9157
Parent 2 has 1 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'rnd-seed'), 271615972)"]
 Parent 3:
 with fitness 3.9386
Parent 3 has 1 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'lbd-cut'), 5.505651748456527)"]
 Parent 4:
 with fitness 3.0816
Parent 4 has 1 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'var-decay'), 0.8847244277883496)"]
 Parent 5:
 with fitness 3.9273
Parent 5 has 2 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'lbd-cut'), 4.273724199634221)", "ParamSetting(('minisat_advanced.params', 'param', 'grow'), -6920)"]
