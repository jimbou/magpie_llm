...
Available parents:
 Parent 1:
 with fitness 6.903
Parent 1 has 2 edits: ["ParamSetting(('test.params', 'param', 'PHASE'), 'PhaseCachingAutoEraseStrategy')", "ParamSetting(('test.params', 'param', 'VARDECAY'), 0.31718469790285775)"]
 Parent 2:
 with fitness 6.9253
Parent 2 has 2 edits: ["ParamSetting(('test.params', 'param', 'LUBYFACTOR'), 78)", "ParamSetting(('test.params', 'param', 'LUBYFACTOR'), 116)"]
 Parent 3:
 with fitness 6.8157
Parent 3 has 3 edits: ["ParamSetting(('test.params', 'param', 'PHASE'), 'PhaseCachingAutoEraseStrategy')", "ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 62)", "ParamSetting(('test.params', 'param', 'VARDECAY'), 0.31718469790285775)"]
 Parent 4:
 with fitness 6.9149
Parent 4 has 5 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 198)", "ParamSetting(('test.params', 'param', 'VARDECAY'), 0.31718469790285775)", "ParamSetting(('test.params', 'param', 'SIMP'), 'EXPENSIVE_SIMPLIFICATION')", "ParamSetting(('test.params', 'param', 'PHASE'), 'RSATPhaseSelectionStrategy')", "ParamSetting(('test.params', 'param', 'LUBYFACTOR'), 78)"]
 Parent 5:
 with fitness 6.8984
Parent 5 has 5 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 62)", "ParamSetting(('test.params', 'param', 'LUBYFACTOR'), 311)", "ParamSetting(('test.params', 'param', 'VARDECAY'), 0.31718469790285775)", "ParamSetting(('test.params', 'param', 'SIMP'), 'EXPENSIVE_SIMPLIFICATION')", "ParamSetting(('test.params', 'param', 'PHASE'), 'RSATPhaseSelectionStrategy')"]
