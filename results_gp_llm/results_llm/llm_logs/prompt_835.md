...
Available parents:
 Parent 1:
 with fitness 3.5234
Parent 1 has 1 edits: ["ParamSetting(('weka.params', 'param', 'I'), 28)"]
 Parent 2:
 with fitness 3.6263
Parent 2 has 1 edits: ["ParamSetting(('weka.params', 'param', 'P'), 20)"]
 Parent 3:
 with fitness 6.2549
Parent 3 has 1 edits: ["ParamSetting(('weka.params', 'param', 'K'), 2)"]
 Parent 4:
 with fitness 2.3876
Parent 4 has 1 edits: ["ParamSetting(('weka.params', 'param', 'P'), 3)"]
 Parent 5:
 with fitness 2.7772
Parent 5 has 1 edits: ["ParamSetting(('weka.params', 'param', 'I'), 14)"]
