...
Parent 1 has 2 edits: ["ParamSetting(('test.params', 'param', 'VARDECAY'), 0.31718469790285775)", "ParamSetting(('test.params', 'param', 'SIMP'), 'EXPENSIVE_SIMPLIFICATION')"]
 Parent 2:
 with fitness 6.8754
Parent 2 has 1 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 198)"]
 Parent 3:
 with fitness 6.8164
...
Parent 4 has 1 edits: ["ParamSetting(('test.params', 'param', 'VARDECAY'), 0.31718469790285775)"]
 Parent 5:
 with fitness 6.8984
Parent 5 has 4 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 62)", "ParamSetting(('test.params', 'param', 'LUBYFACTOR'), 311)", "ParamSetting(('test.params', 'param', 'VARDECAY'), 0.31718469790285775)", "ParamSetting(('test.params', 'param', 'SIMP'), 'EXPENSIVE_SIMPLIFICATION')"]
