...
Parent 1 has 1 edits: ["ParamSetting(('test.params', 'param', 'VARDECAY'), 0.31718469790285775)"]
 Parent 2:
 with fitness 6.8665
Parent 2 has 4 edits: ["ParamSetting(('test.params', 'param', 'INITCONFLICTBOUND'), 347)", "ParamSetting(('test.params', 'param', 'VARDECAY'), 0.31718469790285775)", "ParamSetting(('test.params', 'param', 'SIMP'), 'NO_SIMPLIFICATION')", "ParamSetting(('test.params', 'param', 'FIXEDPERIOD'), 7023)"]
 Parent 3:
 with fitness 6.9539
Parent 3 has 1 edits: ["ParamSetting(('test.params', 'param', 'LUBYFACTOR'), 311)"]
 Parent 4:
 with fitness 6.9698
Parent 4 has 1 edits: ["ParamSetting(('test.params', 'param', 'PHASE'), 'PhaseCachingAutoEraseStrategy')"]
 Parent 5:
 with fitness 6.8164
