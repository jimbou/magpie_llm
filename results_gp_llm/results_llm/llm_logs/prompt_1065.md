...
Parent 1 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'memLevel'), 5)"]
 Parent 2:
 with fitness 7.7492
Parent 2 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'level'), 7)"]
 Parent 3:
 with fitness 7.7353
Parent 3 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'strategy'), 3)"]
 Parent 4:
 with fitness 7.7619
Parent 4 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'wbits'), 30)"]
 Parent 5:
 with fitness 7.7353
