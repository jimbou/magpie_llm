...
Parent 2 has 1 edits: ["ParamSetting(('lpg.params', 'param', 'search_steps'), 889)"]
 Parent 3:
 with fitness 9.5033
Parent 3 has 1 edits: ["ParamSetting(('lpg.params', 'param', 'restarts'), 4)"]
 Parent 4:
 with fitness 8.1513
Parent 4 has 1 edits: ["ParamSetting(('lpg.params', 'param', 'noise'), 0.05071109975798627)"]
 Parent 5:
 with fitness 9.4134
Parent 5 has 1 edits: ["ParamSetting(('lpg.params', 'param', 'lowmemory'), 'True')"]
