...
Parent 1 has 3 edits: ["ParamSetting(('weka.params', 'param', 'P'), 3)", "ParamSetting(('weka.params', 'param', 'K'), 2)", "ParamSetting(('weka.params', 'param', 'I'), 14)"]
 Parent 2:
 with fitness 2.1789
Parent 2 has 4 edits: ["ParamSetting(('weka.params', 'param', 'I'), 28)", "ParamSetting(('weka.params', 'param', 'P'), 3)", "ParamSetting(('weka.params', 'param', 'M'), 2)", "ParamSetting(('weka.params', 'param', 'P'), 11)"]
 Parent 3:
 with fitness 2.0695
Parent 3 has 3 edits: ["ParamSetting(('weka.params', 'param', 'I'), 14)", "ParamSetting(('weka.params', 'param', 'M'), 2)", "ParamSetting(('weka.params', 'param', 'P'), 20)"]
 Parent 4:
 with fitness 2.2714
Parent 4 has 2 edits: ["ParamSetting(('weka.params', 'param', 'P'), 11)", "ParamSetting(('weka.params', 'param', 'I'), 28)"]
 Parent 5:
 with fitness 1.7777
Parent 5 has 2 edits: ["ParamSetting(('weka.params', 'param', 'I'), 14)", "ParamSetting(('weka.params', 'param', 'P'), 3)"]
