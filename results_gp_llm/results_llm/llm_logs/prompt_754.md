...
Parent 1 has 1 edits: ["ParamSetting(('lpg.params', 'param', 'search_steps'), 907)"]
 Parent 2:
 with fitness 9.4422
Parent 2 has 1 edits: ["ParamSetting(('lpg.params', 'param', 'lowmemory'), 'None')"]
 Parent 3:
 with fitness 9.5033
Parent 3 has 1 edits: ["ParamSetting(('lpg.params', 'param', 'restarts'), 4)"]
 Parent 4:
 with fitness 9.4422
Parent 4 has 1 edits: ["ParamSetting(('lpg.params', 'param', 'static_noise'), 'None')"]
 Parent 5:
 with fitness 6.1969
Parent 5 has 1 edits: ["ParamSetting(('lpg.params', 'param', 'search_steps'), 889)"]
