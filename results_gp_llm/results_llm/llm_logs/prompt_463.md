...
Available parents:
 Parent 1:
 with fitness 3.9573
Parent 1 has 1 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'sub-lim$bounded'), 6419)"]
 Parent 2:
 with fitness 3.9573
Parent 2 has 1 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'elim'), 'True')"]
 Parent 3:
 with fitness 3.9573
Parent 3 has 1 edits: ["ParamSetting(('minisat_advanced.params', 'param', '@sub-lim$flag'), 'False')"]
 Parent 4:
 with fitness 3.6292
Parent 4 has 1 edits: ["ParamSetting(('minisat_advanced.params', 'param', 'var-decay'), 0.825520469471721)"]
 Parent 5:
 with fitness 3.9573
