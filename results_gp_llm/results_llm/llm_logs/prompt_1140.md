...
Available parents:
 Parent 1:
 with fitness 5.7216
Parent 1 has 4 edits: ["ParamSetting(('zlib.params', 'param', 'wbits'), 30)", "ParamSetting(('zlib.params', 'param', 'memLevel'), 7)", "ParamSetting(('zlib.params', 'param', 'strategy'), 2)", "ParamSetting(('zlib.params', 'param', 'level'), 7)"]
 Parent 2:
 with fitness 5.7202
Parent 2 has 5 edits: ["ParamSetting(('zlib.params', 'param', 'wbits'), 30)", "ParamSetting(('zlib.params', 'param', 'strategy'), 2)", "ParamSetting(('zlib.params', 'param', 'memLevel'), 7)", "ParamSetting(('zlib.params', 'param', 'level'), 5)", "ParamSetting(('zlib.params', 'param', 'wbits'), 30)"]
 Parent 3:
 with fitness 7.0309
Parent 3 has 1 edits: ["ParamSetting(('zlib.params', 'param', 'memLevel'), 8)"]
 Parent 4:
 with fitness 5.7202
